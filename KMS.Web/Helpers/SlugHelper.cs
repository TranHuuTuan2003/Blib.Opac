...
namespace KMS.Web.Helpers
{
    ...
    {
        public static string ToSlug(string text, string formTypeId)
        {
            ...
            bool hasFormType = formTypeId != "search" && formTypeId != "pdoc" && formTypeId != "ddoc" && formTypeId != "home";
